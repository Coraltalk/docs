...
<Tabs>
  <Tab title="LTI 1.3 (Recommended)">
    **Modern, secure LTI integration**
    ...
    [See LTI 1.3 setup guide](/integrations/canvas-lti)
  </Tab>
  ...
  <Tab title="REST API">
    **Alternative integration using Canvas API**
    ...
    [See REST API setup guide](/integrations/canvas-rest-api)
  </Tab>
</Tabs>
...
<AccordionGroup>
  <Accordion title="School administrators (recommended)">
    **Best for**: Multi-course deployments, school-wide adoption
    ...
    See [Guide for school administrators](/getting-started/for-school-admins)
  </Accordion>
...
<Tip>
For detailed step-by-step instructions with screenshots, see the [Canvas LTI setup guide](/integrations/canvas-lti)
</Tip>
...
See [Canvas REST API guide](/integrations/canvas-rest-api) for full instructions.
...
<CardGroup cols={2}>
  <Card title="LTI setup details" icon="book" href="/integrations/canvas-lti">
    Complete LTI 1.3 configuration steps
  </Card>
  
  <Card title="REST API setup" icon="code" href="/integrations/canvas-rest-api">
    Alternative Canvas integration
  </Card>
  
  <Card title="For school admins" icon="building-columns" href="/getting-started/for-school-admins">
