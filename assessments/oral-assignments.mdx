...
<Info>
Question wording, suggested difficulty, and grading rigor all adapt to the **audience level** set on your teaching assistant (high school, undergraduate, post graduate, adult learning, or corporate training). Set the level under **Customize** before generating questions for the best fit. See [Audience level](/teaching-assistant/customize-ta#audience-level).
</Info>
