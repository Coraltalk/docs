...
Coral's answers are grounded in your uploaded materials. See [Knowledge library](/teaching-assistant/knowledge-library) for:
...
<Card title="Review student chats" icon="messages" href="/teaching-assistant/review-student-chats">
...
<CardGroup cols={2}>
  <Card title="Knowledge library" icon="books" href="/teaching-assistant/knowledge-library">
    Upload course materials for Coral
  </Card>
  
  <Card title="Review chats" icon="messages" href="/teaching-assistant/review-student-chats">
    Monitor student conversations
  </Card>
  
  <Card title="TA overview" icon="headset" href="/teaching-assistant/overview">
