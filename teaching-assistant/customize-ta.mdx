...
**Supported formats:** PDF, DOCX, DOC, PPTX, PPT, and TXT, up to 25 MB per file. The library holds up to 20 MB of content across all files. Password-protected PDFs are rejected — remove the password before uploading.
