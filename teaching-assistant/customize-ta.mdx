...
Set the **audience level** for your class so Coral matches its vocabulary, examples, and grading rigor to your learners. The level you choose flows into Coral's tutoring, AI question generation, and oral assignment evaluation automatically.

<AccordionGroup>
  <Accordion title="Available levels">
    - **High school** — Grades 9–12
    - **Undergraduate** — Freshman through senior
    - **Post graduate** — Master's, PhD, postdoctoral
    - **Adult learning** — Continuing education, professional development, certifications, workshops
    - **Corporate training** — Entry, mid, senior, executive, or team training
    - **Other** — Custom, mixed, or unspecified
  </Accordion>

  <Accordion title="What changes when you set a level">
    - **Question generation** uses vocabulary and concept depth appropriate for the tier (e.g., concrete scenarios for younger learners, scenario-based reasoning for corporate training).
    - **Suggested difficulty** for new oral and written questions adjusts to match the audience.
    - **AI evaluation** grades for age- and tier-appropriate depth instead of one universal standard.
    - **Coral's tone** in tutoring conversations shifts (warmer and simpler for younger audiences, more rigorous for graduate and executive learners).
  </Accordion>
</AccordionGroup>

<Tip>
Pick the level that matches the majority of your learners. For mixed cohorts, choose **Other → Mixed Levels** so Coral keeps language accessible without dumbing down content.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Moodle integration" icon="graduation-cap" href="/integrations/moodle-integration">
    Connect Coraltalk to Moodle
  </Card>
</CardGroup>
