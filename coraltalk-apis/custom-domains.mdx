...
Platform API calls remain on `app.coraltalk.com/api/v1/...`. For student sign-in on custom domains, use [Student sign-in token](/coraltalk-apis/student-sign-in-token) from your server with a Platform API key.
