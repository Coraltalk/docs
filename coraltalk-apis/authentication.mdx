...
Platform API access is available to organizations on a **volume-based pricing plan**. If your organization isn't on volume-based pricing, **Create key** fails with a `403` and the error code `volume_pricing_required`.
